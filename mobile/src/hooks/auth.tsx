...
const CLIENT_ID = "ad6a6ce1a6656d23635e";
  ...
  async function signIn() {
    try {
      ...
      const authSessionResponse = (await AuthSessions.startAsync({
        authUrl,
      })) as AuthorizationRepsonse;

      if (authSessionResponse.type === 'success' && authSessionResponse.params.error !== 'acesss_denied') {
